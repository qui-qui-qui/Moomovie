...
function AddToFavorite({ handleClick, isFavorite }: Props) {
    return (
        <button
            className="block group overflow-hidden rounded-md bg-blue-100 px-5 lg:w-auto"
            onClick={handleClick}
        >
            <svg
                width="33"
                ...
                className="absolute top-3 right-1 h-8 w-8"
            >
                <path
